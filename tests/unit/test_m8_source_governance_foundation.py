...
def test_registry_json_shape_and_required_source_ids():
    ...
    assert registry["status"] in {"m8_00_governance_foundation_defined", "m8_through_m8b_implemented_with_caveats", "m8c_01_taifex_mis_bounded_snapshot_runtime_pass_with_caveats"}
