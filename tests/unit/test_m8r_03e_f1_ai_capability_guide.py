...
def test_active_registry_successor_advances_to_r3():
 assert REG['recommended_next_task']=='M8R-03E-POST-R4-PHASE-C-READINESS-AND-R5-SEQUENCING-DECISION'

def test_phase_c_blocked_pending_r3_critical_subset():
 assert CONTRACT['phase_dependencies']['Phase C']=='blocked_pending_R4'
...
def test_registry_status_surfaces_agree():
 r3='M8R-03E-POST-R4-PHASE-C-READINESS-AND-R5-SEQUENCING-DECISION'
