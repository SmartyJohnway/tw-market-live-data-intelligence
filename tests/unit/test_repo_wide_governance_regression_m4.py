...
def test_workflow_no_probes_or_prod():
 y=(ROOT/'.github/workflows/non-network-ci.yml').read_text(encoding="utf-8").lower(); assert 'run_all_probes' not in y; assert 'production refresh' not in y; assert 'broker' not in y
