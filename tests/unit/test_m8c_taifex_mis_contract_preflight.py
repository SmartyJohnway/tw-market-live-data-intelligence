...
def test_planning_state_has_single_next_task_and_inventory_section():
    ...
    assert reg['next_task']=='M8R-01F-CANONICAL-REQUEST-HASH-AND-SEMANTIC-DUPLICATE-CORRECTION'
    assert reg['next_task_status']=='operator_approved_not_started'
    assert reg['m8_active_consolidated_status']['next_task']=='M8R-01F-CANONICAL-REQUEST-HASH-AND-SEMANTIC-DUPLICATE-CORRECTION'
    assert reg['planning_state']['next_task']=='M8R-01F-CANONICAL-REQUEST-HASH-AND-SEMANTIC-DUPLICATE-CORRECTION'
