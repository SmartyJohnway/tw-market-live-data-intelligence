...
def test_acceptance_docs_and_inventory_closed():
    doc=(ROOT/'docs/protocol/M8A_OFFICIAL_EOD_CONTEXT_FINAL_ACCEPTANCE.md').read_text(encoding="utf-8")
...
def test_readme_static_contracts_and_registry_roles():
    ...
    reg=json.loads((ROOT/'docs/data_capabilities/m8_source_capability_registry.json').read_text(encoding="utf-8"))
