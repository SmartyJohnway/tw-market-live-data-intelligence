...
def test_observability_model_flags():
 t=(ROOT/'frontend/readonly-preview/observabilityModel.js').read_text(encoding="utf-8"); assert 'tradingSignal: false' in t and 'realtimeGuaranteed: false' in t
def test_governance_console_renders_panels():
 t=(ROOT/'frontend/readonly-preview/governance-console.js').read_text(encoding="utf-8");
