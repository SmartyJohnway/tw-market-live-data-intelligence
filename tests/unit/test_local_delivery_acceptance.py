...
def test_forbidden_string_detection(tmp_path):
    (tmp_path/"docs/contracts").mkdir(parents=True); (tmp_path/"docs/contracts/frontend_readonly_context_package_schema.md").write_text("realtime_guaranteed: true", encoding="utf-8")
