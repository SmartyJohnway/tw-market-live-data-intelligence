...
def test_inventory_m7g_04_05_status():
    ...
    assert entry['status'] in {'real_safe_artifact_rendering_and_provenance_source_health_defined', 'ai_handoff_from_loaded_safe_artifact_defined'}
    assert entry['completed_tasks'] in (['M7G-00','M7G-01','M7G-02','M7G-03','M7G-04','M7G-05'], ['M7G-00','M7G-01','M7G-02','M7G-03','M7G-04','M7G-05','M7G-06'])
    ...
    assert entry['next_task'] in {'M7G-06-AI-HANDOFF-FROM-LOADED-SAFE-ARTIFACT', 'M7G-07-08-OPERATOR-REFRESH-WORKFLOW-POLICY-AND-CONTROLLED-REFRESH-REQUEST-PACKAGE'}
