...
def test_inventory_m7g_04_05_status():
    ...
    assert entry['status'] in {
        'real_safe_artifact_rendering_and_provenance_source_health_defined',
        'ai_handoff_from_loaded_safe_artifact_defined',
        'refresh_workflow_policy_and_request_package_defined',
    ...
    assert entry['completed_tasks'] in (
        ['M7G-00','M7G-01','M7G-02','M7G-03','M7G-04','M7G-05'],
        ['M7G-00','M7G-01','M7G-02','M7G-03','M7G-04','M7G-05','M7G-06'],
        ['M7G-00','M7G-01','M7G-02','M7G-03','M7G-04','M7G-05','M7G-06','M7G-07','M7G-08'],
    ...
    assert entry['next_task'] in {
        'M7G-06-AI-HANDOFF-FROM-LOADED-SAFE-ARTIFACT',
        'M7G-07-08-OPERATOR-REFRESH-WORKFLOW-POLICY-AND-CONTROLLED-REFRESH-REQUEST-PACKAGE',
        'M7G-09-CONTROLLED-MANUAL-REFRESH-EXECUTION-INTEGRATION-GATE',
