...
def test_no_network_and_deterministic(monkeypatch):
 ...
 monkeypatch.setattr(socket,'socket',blocked); monkeypatch.setattr(socket,'create_connection',blocked); monkeypatch.setattr(requests.sessions.Session,'request',blocked); monkeypatch.setattr(httpx.Client,'request',blocked); monkeypatch.setattr(urllib.request,'urlopen',blocked)
