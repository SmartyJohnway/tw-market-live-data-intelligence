# Archived pre-M5R README

Archived from:
- source file: README.md
- archive date: 2026-06-30
- task: M5R-PRODUCT-RELEASE-HARDENING-AND-REPOSITORY-INFORMATION-ARCHITECTURE
- reason: pre-M5R README preserved before final product release hardening
