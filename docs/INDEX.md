...
- M8R-02 status = `CONDITIONAL_GO`; next_task = `null`; next_task_status = `awaiting_operator_acceptance`; recommended_next_task = `M8R-03-AI-MARKET-CONTEXT-PRODUCT-PACKAGE`
