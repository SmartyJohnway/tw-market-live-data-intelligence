...
| **TWSE MIS** | Unofficial (`unofficial_frontend_endpoint`) | Delayed Intraday | None | None | Selected TWSE/TPEx assets | Bounded live watchlist | Automated trading, scraping | High risk, undocumented rate limits, schema drift | High risk for AI; contextual hints only |
