# M8C TAIFEX MIS personal use access disposition
...
## Access use disposition

`access_use_disposition = operator_accepted_personal_local_research_only`

This is project governance, not legal advice. It does not authorize public redistribution, resale, multi-user market-data delivery, authentication/CAPTCHA/rate-limit/control bypass, raw full-market or full-chain retention, or public API/MCP/multi-user exposure without separate review. Runtime must remain operator-triggered and bounded.
