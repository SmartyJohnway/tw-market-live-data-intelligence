...
PR-head validation on July 13, 2026 ran `python scripts/run_test_profile.py full-non-network --json`. The run retained the known seven M5D/M5E frontend-publication baseline drift failures and introduced no new M8/M8C regression. M8-family focused tests and default CI passed.
