...
### Failure Summary
- Baseline Failures: 26
- HEAD Failures: 22
- Novel Failures: 0
- Resolved Failures: 4
- Unchanged Failures: 22

### Novel Failures
None

### Resolved Failures
- `tests/unit/test_probes.py::test_twse_openapi_offline`
- `tests/unit/test_probes.py::test_twse_openapi_failure`
- `tests/unit/test_probes.py::test_yahoo_probe_offline`
