...
def main(argv=None):
 ap=argparse.ArgumentParser(); ap.add_argument('--results',required=True); a=ap.parse_args(argv); print(json.dumps(summarize_replay_results(json.loads(Path(a.results).read_text(encoding="utf-8"))),indent=2)); return 0
