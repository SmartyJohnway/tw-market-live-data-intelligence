...
def main():
    ...
    print(dump({'status':'refresh_candidate_created','candidate_dir':str(out),'evidence_dir':str(evidence),'claim_file':str(claim),'http_status':status,**val,'network_calls_may_have_occurred':True})); return 0
