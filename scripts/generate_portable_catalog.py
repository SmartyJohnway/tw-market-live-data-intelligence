...
def generate_portable_markdown_text(portable_data: dict, sha256: str) -> str:
    ...
    md_lines.extend([
        ...
        f"- **Preview Supported**: `{json.dumps(portable_data['execution'].get('preview_supported'))}`",
        f"- **One-Shot Execution**: `{json.dumps(portable_data['execution'].get('one_shot_execution'))}`",
        "",
