...
def main(argv=None):
    ...
    validated=load_verified_security_master_snapshot(ns.snapshot,ns.manifest,allow_fixture_snapshot=ns.allow_fixture_snapshot)
    res=resolve_verified_security_identity(ns.query,validated.lookup,market_context=ns.market_context,allow_fixture_snapshot=ns.allow_fixture_snapshot)
