...
def run(text: str, root: str, *, execution_time_utc: str | None = None, resolver: Any | None = None) -> dict[str, Any]:
    ...
    try:
        ...
        return {"status":"blocked", "resolution": resolution, "ai_package_id": None, "ai_package_status": "build_failed", "ai_validation": {"valid": False, "reason_code": str(exc)}, "operation_results": result.get("operation_results", [])}
