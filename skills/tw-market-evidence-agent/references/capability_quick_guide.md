...
- **Canonical Capability Catalog SHA-256**: `e1d0ac61a7d9eea77dca3e32189e6df53d2d7071fd53f6b39b8a0120f1653463`
...
| `trading_status_context` | `runtime_executable` | TWSE, TPEX | Approval Required | partial_attention_only | No | only H1-TPEX-ATTENTION-OPENAPI is active; all other H1 status subtypes/routes remain inactive or uncovered; H0-SRC-02 prevents complete H1 coverage claims; V2 remains the preferred production request/result authority |
| `corporate_action_context` | `contract_supported` | TWSE, TPEX | Approval Required | explicit_target_scoped_time_bounded | No | Not currently runtime-executable; V3 contract candidate only; no H0-G runtime activation; coverage and provider asymmetry remain explicit |
