...
| `recent_performance` | `contract_supported` | TWSE, TPEX | Approval Required | catalog-defined | No | Not currently runtime-executable; TWSE public STOCK_DAY bounded route is Owner-approved for controlled local-first use and eligible for H-ACT-H3 preflight, but provider automation permission remains not established / terms-conflicted; TPEx default bounded route and optional provider contracts remain unresolved; no persistent history accumulation |
