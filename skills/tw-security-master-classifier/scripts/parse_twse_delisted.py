#!/usr/bin/env python3
"""Parse a supplied TWSE terminated-listing official HTML capture."""
...
def parse(data: bytes, source_url: str) -> list[dict]:
    return parse_standard_table(data, event_type="twse_delisted", source_family="twse_termination_table", source_url=source_url)
...
if __name__ == "__main__":
    ...
    try:
        ...
        result={"acquisition_status":"data" if events else "empty_valid","event_count":len(events),"events":events,"issues":[]}; exit_code=0
